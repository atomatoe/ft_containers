...
/*   Updated: 2021/01/22 18:34:49 by atomatoe         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int main()
{
    ...
    // //********************************************************
	// ft::list<int> my2(21, 777);
	// std::list<int> test2(21, 777);
	...
	// else
	// 	std::cout << "Конструктор копирования прошлого результата - | \x1B[31mKO\x1B[0m |" << std::endl;
	// ft::list<long> long_test(12, 22);
	// std::list<long> long_test2(12, 22);
	...
	// // 	std::cout << *iter2 << std::endl;
	// // ********************************************************
	// ft::list<int> my5(1000, 5000);
	// std::list<int> test5(1000, 5000);
	// ft::list<double> my5_d(1000, 5.5);
	// std::list<double> test5_d(1000, 5.5);
	// ft::list<std::string> my5_s(1000, "hi");
	// std::list<std::string> test5_s(1000, "hi");
	...
	// //********************************************************
	// ft::list<int> my6(10000, 21);
	// std::list<int> test6(10000, 21);
	...
	// //********************************************************
	// ft::list<int> my7(100000, 42);
	// std::list<int> test7(100000, 42);
	...
	// // // ********************************************************
	// // ft::list<int> test_it(4, 11);
	// // std::list<int> test2_it(4, 11);
